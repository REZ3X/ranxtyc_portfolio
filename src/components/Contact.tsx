...
export default function Contact() {
  ...
  return (
    <section ref={ref} id="contact" className="py-16 sm:py-20 section-bg-alt">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div
          className={`text-center mb-10 sm:mb-12 fade-in-up ${
            isVisible ? "animate" : ""
          }`}
        >
          ...
          <p className="text-base sm:text-lg text-slate-300 max-w-xl mx-auto font-light">
            Let&apos;s discuss electronics projects and collaboration
            opportunities
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-8">
          ...
          >
            <div>
              ...
              <p className="text-sm text-slate-300 mb-6 font-light">
                I&apos;m excited to discuss new projects and innovative ideas in
            ...
            <div className="border-t border-slate-700 pt-6">
              ...
              <div className="flex space-x-3">
                <a
                  href="https://www.instagram.com/ranxtyc"
                  target="_blank"
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full accent-gradient text-white px-4 py-2 rounded-lg hover:shadow-lg hover:shadow-sky-500/25 transition-all duration-200 font-light transform hover:scale-105 text-sm cursor-pointer"
              >
                Send Message
              </button>
            </form>
