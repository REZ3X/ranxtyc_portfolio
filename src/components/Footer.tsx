        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="col-span-2">
            ...
            <div className="flex space-x-3">
              <a
                href="#"
                className="w-11 h-11 bg-blue-600 rounded-xl flex items-center justify-center hover:bg-blue-700 transition-all duration-300 hover:scale-110"
              >
                <svg
              ...
              <a
                href="#"
                className="w-11 h-11 bg-blue-700 rounded-xl flex items-center justify-center hover:bg-blue-800 transition-all duration-300 hover:scale-110"
              >
                <svg
                  className="w-5 h-5 text-white"
                  fill="currentColor"
              ...
              <a
                href="#"
                className="w-11 h-11 bg-zinc-700 rounded-xl flex items-center justify-center hover:bg-zinc-600 transition-all duration-300 hover:scale-110"
              >
                <svg
                  className="w-5 h-5 text-white"
                  fill="currentColor"
              ...
              <a
                href="#"
                className="w-11 h-11 bg-pink-600 rounded-xl flex items-center justify-center hover:bg-pink-700 transition-all duration-300 hover:scale-110"
              >
                <svg
                  className="w-5 h-5 text-white"
                  fill="currentColor"
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href="#home"
                  className="text-slate-300 hover:text-blue-400 transition-colors duration-200 font-light"
                >
                  Home
                </a>
              </li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-6 text-sm">
              <span className="text-slate-400 font-light">
                Made with 💙 for Electronics Engineering
              </span>
